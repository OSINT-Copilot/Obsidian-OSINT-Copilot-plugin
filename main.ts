export { default } from './src/plugin/vault-ai-plugin';
export { ChatView, CHAT_VIEW_TYPE } from './src/views/chat-view';

export type { IndexedNote } from './src/chat/indexed-note';
